# -*- coding: utf-8 -*-
"""
Created on Tue Nov 23 07:11:25 2021
...
if __name__ == "__main__":    
    ...
    var1 = int(input('il y a combien de variable ?: '))
    cons1 = int(input('il y a combien de constrainte ?: '))
    m = gen_matrix(var1,cons1)
    
    for i in range(cons1):
        contrain = str(input(f'Entrer la liste de la valeur du coefficient de variable dans contrainte numero {i+1} (ex: 1,1,<=,4): '))
        constrain(m,contrain)
    
    o= str(input('Entrer la liste de variable dans fonction objective (ex: 3,4,0): '))
    obj(m,o)
    t=input("Veuillez entrer le type de problème (max ou min) : ")
    if t=='max':
        print('\nSolution:\n', maxz(m))
    if t=='min':
        print('\nSolution:\n', minz(m))
    ...
    #Question 2
    # m = gen_matrix(2,3)
    # constrain(m,'400,300,>=,25000')
    # constrain(m,'300,400,>=,27000')
    # constrain(m,'200,500,>=,30000')
    # obj(m,'20000,25000')
    # print(minz(m))
